    ...
    public void encodeWithFiles() throws IOException
    {
        ...
        try {
            reader = new BufferedReader(
                new FileReader("DIP/src/com/directi/training/dip/exercice_refactored/beforeEncryption.txt"));
            writer = new BufferedWriter(
                new FileWriter("DIP/src/com/directi/training/dip/exercice_refactored/afterEncryption.txt"));
            String aLine;
